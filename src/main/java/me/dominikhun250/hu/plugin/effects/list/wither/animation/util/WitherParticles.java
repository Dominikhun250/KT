package me.dominikhun250.hu.plugin.effects.list.wither.animation.util;
...
public class WitherParticles {
    ...
    public static void spawnWitherExplosion(Location center) {
        ...
        for (int i = 0; i < 360; i += 10) {
            ...
            world.spawnParticle(Particle.DUST, ringLoc, 5, 0.2, 0.2, 0.2, 0.01, new Particle.DustOptions(Color.fromRGB(255, 255, 255), 0.5f));
            world.spawnParticle(Particle.DUST, ringLoc, 10, 0.2, 0.2, 0.2, 0.01, new Particle.DustOptions(Color.fromRGB(30, 180, 230), 0.6f));
        }
    }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < 60; i++) {
                    ...
                    world.spawnParticle(Particle.DUST, pLoc, 10, 0.2, 0.2, 0.2, 0.01, new Particle.DustOptions(Color.fromRGB(58, 22, 240), 0.5f));
