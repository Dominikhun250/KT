package me.dominikhun250.hu.plugin.effects.list.dimensionalrift.animation.util;
...
public class RiftParticles {
    ...
    public static void spawnHugeOpeningRing(World world, Location center, int tick) {
        ...
        for (int i = 0; i < points; i++) {
            ...
            world.spawnParticle(Particle.DUST, loc, 2, 0.07, 0.07, 0.07, 0.025, new Particle.DustOptions(Color.fromRGB(56, 189, 255), 0.6f));
            if (tick % 3 == 0) {
    ...
    public static void spawnGlitchVortex(World world, Location center, int tick) {
        ...
        for (int i = 0; i < points; i++) {
            ...
            world.spawnParticle(Particle.DUST, loc, 2, 0.07, 0.07, 0.07, 0.025, new Particle.DustOptions(Color.fromRGB(56, 189, 255), 1.8f));
            if (tick % 5 == 0 && i % 15 == 0) {
                world.spawnParticle(Particle.DUST, loc, 2, 0.07, 0.07, 0.07, 0.025, new Particle.DustOptions(Color.fromRGB(56, 189, 255), 0.55f));
            }
        }
    }
    ...
    public static void spawnGlitchRingMovement(World world, Location center, int tick) {
        ...
        for (int i = 0; i < points; i++) {
            ...
            if (tick % 3 == 0) {
                world.spawnParticle(Particle.DUST, loc, 2, 0.07, 0.07, 0.07, 0.025, new Particle.DustOptions(Color.fromRGB(56, 189, 255), 1.2f));
            }
            if (tick % 4 == 0 && i % 10 == 0) {
        ...
        for (int i = 0; i < beamCount; i++) {
            ...
            for (double y = 0; y < maxHeight; y += 0.3) {
                ...
                if (y % 1 < 0.3 && (tick + i) % 5 == 0) {
                    ...
                    world.spawnParticle(Particle.DUST, loc, 2, 0.07, 0.07, 0.07, 0.025, new Particle.DustOptions(Color.fromRGB(56, 189, 255), 1.5f));
                }
            }
        }
    }
