package me.dominikhun250.hu.plugin.effects.list.explosion.animation.util;
    ...
    public static void launchCosmeticTNT(final KT plugin, final Location center, Player killer) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                world.spawnParticle(Particle.SOUL_FIRE_FLAME, loc, 3, 0.1, 0.1, 0.1, 0.05);
    ...
    private static void spawnExplosionParticles(World world, Location loc) {
        ...
        for (int layer = 0; layer < 4; layer++) {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                world.spawnParticle(Particle.DRIPPING_WATER, particleLoc, 1, 0.05, 0.05, 0.05, 0.01);

                Location colorLoc = particleLoc.clone().add(0, Math.sin(angle * 4) * 0.3, 0);
                world.spawnParticle(Particle.DUST, colorLoc, 1, 0, 0, 0,
                        new Particle.DustOptions(Color.fromRGB(30, 180 + layer * 10, 230 + layer * 5), 1.5f));
